...
> **📖 For Visitors**: 專案介紹、設計亮點、快速開始指南  
> **🤖 For AI Agents**: 請閱讀 `agents.MD` 作為入口
...
├── _sass/                  # 樣式系統
│   ├── design-system/     # 🎨 設計系統核心（v4.0.0）
│   │   ├── _variables.scss  # 單一真相來源：8色系統、字體、間距
│   │   └── _mixins.scss     # DRY 工具：badge/card 自動生成器
│   └── custom/            # 自訂樣式
│       ├── _homepage.scss
│       ├── _about.scss
│       ├── _posts-archive.scss
...
### v3.0.0 (2025-10-28)
- 📚 **文件系統優化** - 明確受眾定位
  - README.md 專注於訪客體驗（本文件）
  - agents.MD 作為 AI Agents 入口
  - docs/ 提供完整規格查閱
- 🔄 **版本統一** - 所有核心文件更新至 v3.0.0
- ✂️ **DOC_INDEX 精簡** - 從 378 行減至 122 行（68% 精簡）
...
- ✅ Posts Archive 完成 - Fashion Magazine Layout
- ✅ Post Single 完成 - TOC + Typography
- ✅ 8 色語義化配色系統完整實作
